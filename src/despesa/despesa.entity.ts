import { Column,Decimal128,Entity, ManyToMany, ManyToOne, NumericType, OneToMany, PrimaryGeneratedColumn } from "typeorm"
...
export class DespesaEntity {
    ...
    @ManyToOne(() => UsuarioEntity, (usuario) => usuario.despesa)
